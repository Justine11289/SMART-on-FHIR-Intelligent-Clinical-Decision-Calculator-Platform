...
const config = {
    ...
    infoAlert: '<strong>Note:</strong> This is the Simplified (Modified) Revised Geneva Score. Each criterion is worth 1 point (except heart rate scoring).',
    ...
    customInitialize: async (client, patient, container, calculate) => {
        ...
        const setRadio = (id, value) => {
            const radio = container.querySelector(`input[name="${id}"][value="${value}"]`);
            if (radio) {
                radio.checked = true;
