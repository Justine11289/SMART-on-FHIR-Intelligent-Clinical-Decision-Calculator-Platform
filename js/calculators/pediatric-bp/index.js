...
export const pediatricBP = createUnifiedFormulaCalculator({
    ...
    description: 'Evaluates blood pressure in children and adolescents (1-18 years) based on AAP 2017 guidelines.',
    infoAlert: `
            ...
            fields: [
                {
                    ...
                    id: 'peds-bp-age',
                    label: 'Age',
                    helpText: 'Decimal values recommended (e.g., for a child who is 5 years and 6 months, enter 5.5)',
                    unit: 'years',
                    placeholder: 'e.g., 5.5',
                    min: 1,
                    max: 18,
            ...
            fields: [
                {
                    ...
                    id: 'peds-bp-sbp',
                    label: 'Systolic BP',
                    helpText: 'Normal values are age-dependent; do not use this calculator in patients with hypotension',
                    unit: 'mmHg',
    ...
    formulaSection: {
        ...
        calculationNote: 'Classification is based on percentiles for ages 1-12, and static thresholds for ≥13 years.',
        scoringCriteria: [
