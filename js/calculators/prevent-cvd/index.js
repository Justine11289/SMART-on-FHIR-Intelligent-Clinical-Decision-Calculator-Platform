...
export const preventCVD = createUnifiedFormulaCalculator({
    ...
    description: 'Predicts 10-year risk of total cardiovascular disease (atherosclerotic CVD + heart failure) using the AHA PREVENT equations.',
    infoAlert: 'Valid for ages 30-79. Not applicable to patients with established CVD. The minimum uACR value accepted is 0.1 mg/g.',
    ...
    customInitialize: async (client, patient, container, calculate) => {
        ...
        try {
            ...
            if (bpResult.systolic !== null) {
                const sbpInput = container.querySelector('#prevent-sbp');
                if (sbpInput) {
