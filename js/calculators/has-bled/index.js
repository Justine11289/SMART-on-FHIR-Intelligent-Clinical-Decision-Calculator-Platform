...
export const hasBledConfig = {
    ...
    formulaSection: {
        ...
        scoringCriteria: [
            ...
            {
                criteria: 'Liver disease (cirrhosis or bilirubin >2x normal with AST/ALT/AP >3x normal)',
                points: '1'
            },
            ...
            {
                criteria: 'Medication usage predisposing to bleeding (aspirin, clopidogrel, NSAIDs)',
                points: '1'
            },
