    ...
    customInitialize: async (client, patient, container, calculate) => {
        ...
        try {
            ...
            if (efResult.value !== null) {
                const input = container.querySelector('#maggic-ef');
                if (input) {
            ...
            if (bmiResult.value !== null) {
                const input = container.querySelector('#maggic-bmi');
                if (input) {
            ...
            if (bpResult.systolic !== null) {
                const input = container.querySelector('#maggic-sbp');
                if (input) {
            ...
            if (creatResult.value !== null) {
                const input = container.querySelector('#maggic-creatinine');
                if (input) {
            ...
            if (hasDiabetes)
                setRadio('maggic-diabetes', '3'); // Yes (+3)
            // COPD
            ...
            if (onBB)
                setRadio('maggic-bb', '0'); // Yes (0 points) - Note: Logic is "No (+3)" so if Yes, select 0.
            // ACEi / ARB
            const aceArbCodes = [
            ...
            if (onAceArb)
                setRadio('maggic-acei', '0'); // Yes (0 points)
        }
        catch (e) {
