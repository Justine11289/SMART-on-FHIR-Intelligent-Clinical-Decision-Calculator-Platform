...
const config = {
    ...
    formulaSection: {
        ...
        interpretations: [
            ...
            },
            {
                ...
                interpretation: 'PE can be ruled out if D-dimer level <0.5 µg/mL OR <(age x 0.01) µg/mL',
                severity: 'warning'
            },
            {
                score: '≥13',
    ...
    formulas: [
        {
            label: 'Reference',
            formula: 'Roy, P. M., et al. (2021). Derivation and Validation of a 4-Level Clinical Pretest Probability Score for Suspected Pulmonary Embolism to Safely Decrease Imaging Testing. JAMA Cardiology.'
        }
    ],
