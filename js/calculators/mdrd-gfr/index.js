...
export const mdrdGfrConfig = {
    ...
    customResultRenderer: results => {
        ...
        if (!res)
            return '';
        let note = '';
        if (res.alertClass === 'success')
            note = 'Normal or mildly decreased kidney function.';
        else if (res.alertClass === 'warning')
            note = 'Moderate reduction. Monitor closely.';
        ...
        return `
            ...
            type: res.alertClass === 'success' ? 'info' : res.alertClass,
            message: note
        })}
        `;
    }
