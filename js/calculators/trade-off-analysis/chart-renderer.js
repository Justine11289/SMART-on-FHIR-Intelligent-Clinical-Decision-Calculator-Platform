 ...
 */
export function createTradeOffChart(config) {
    ...
    const canvas = document.getElementById('trade-off-chart-canvas');
    if (!canvas)
        return null;
 ...
 */
export function updateChartPosition(chart, bleedingRisk, ischemicRisk) {
    if (!chart)
        return;
