 ...
 */
export function calculateBleedingRisk(selectedFactorIds) {
 ...
 */
export function calculateIschemicRisk(selectedFactorIds) {
 ...
 */
export function determineRiskZone(bleedingRisk, ischemicRisk) {
    // Equal line: y = x
