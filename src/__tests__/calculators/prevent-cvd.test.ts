...
import {
    ...
    preventCoefficients
} from '../../calculators/prevent-cvd/calculation.js';
...
describe('PREVENT CVD Risk Calculator', () => {
    ...
    describe('Linear Predictor Calculation', () => {
        ...
        test('Diabetes adds positive contribution', () => {
            const transformed = calculateTransformedVariables(55, 5.0, 1.3, 130, 90);
            const withoutDiabetes = calculateLinearPredictor(
                transformed,
                'male',
                false,
                false,
            ...
            const withDiabetes = calculateLinearPredictor(
                transformed,
                'male',
                true,
                false,
            ...
            expect(withDiabetes - withoutDiabetes).toBeCloseTo(
                preventCoefficients.male.diabetes,
                2
            );
        });
        ...
        test('Smoking adds positive contribution', () => {
            const transformed = calculateTransformedVariables(55, 5.0, 1.3, 130, 90);
            const withoutSmoking = calculateLinearPredictor(
                transformed,
                'female',
                false,
                false,
            ...
            const withSmoking = calculateLinearPredictor(
                transformed,
                'female',
                false,
                true,
    ...
    describe('Full Risk Calculation', () => {
        ...
        test('Gender affects risk calculation', () => {
            ...
            const maleRisk = calculatePreventRisk(
                params.age,
                'male',
                params.tc,
                params.hdl,
            ...
            const femaleRisk = calculatePreventRisk(
                params.age,
                'female',
                params.tc,
                params.hdl,
        ...
        test('Statin use affects risk calculation', () => {
            ...
            const withoutStatin = calculatePreventRisk(
                baseParams.age,
                baseParams.gender,
                baseParams.tc,
                baseParams.hdl,
            ...
            const withStatin = calculatePreventRisk(
                baseParams.age,
                baseParams.gender,
                baseParams.tc,
                baseParams.hdl,
